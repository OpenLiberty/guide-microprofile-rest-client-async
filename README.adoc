...
When the service is available you can access the application by using a `curl` command as follows:
...
If the output is empty, the service may not be available yet and additional waiting may be required. 
