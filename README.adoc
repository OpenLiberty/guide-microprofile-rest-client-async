...
The application that you will be working with is a `bff` service,
which acts as a gateway to communicate with backend microservices.
...
Next, use the provided script to start the application in docker container.
