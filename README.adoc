...
:page-seo-title: Consuming RESTful microservices asynchronously using Eclipse MicroProfile Rest Client
:page-seo-description: A tutorial on how to consume RESTful Java microservices with asynchronous method calls using the CompletionStage interface and MicroProfile Rest Client.
