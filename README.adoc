...
You can access the application by making requests to the `query/systemLoad` endpoint by accessing http://localhost:9080/query/systemLoad[localhost:9080/query/systemLoad^].
