...
Switching to an asynchronous programming model has freed up the thread handling your request to `/inventory/systems/{hostname}`. While MicroProfile REST Client makes a request, the thread can handle other work.
