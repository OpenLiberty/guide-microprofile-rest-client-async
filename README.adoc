...
----
include::finish/gateway/src/main/java/io/openliberty/guides/gateway/client/JobClient.java[tags=**;!copyright;]
----
...
[source, Java, linenums, role='code_column']
----
include::finish/gateway/src/main/java/io/openliberty/guides/gateway/GatewayJobResource.java[tags=**;!copyright;]
----
...
[source, Java, linenums, role='code_column']
----
include::finish/gateway/src/test/java/it/io/openliberty/guides/gateway/GatewayJobEndpointIT.java[tags=**;!copyright,javadoc;]
----
