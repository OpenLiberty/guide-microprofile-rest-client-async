...
----
include::finish/gateway/src/main/java/io/openliberty/guides/gateway/client/JobGatewayClient.java[][tags=**;!copyright;]
----
...
[source, Java, linenums, role='code_column']
----
include::finish/gateway/src/main/java/io/openliberty/guides/gateway/JobGatewayResource.java[][tags=**;!copyright;]
----
...
[source, Java, linenums, role='code_column']
----
include::finish/gateway/src/test/java/it/io/openliberty/guides/gateway/JobGatewayEndpointTest.java[][tags=**;!copyright,javadoc;]
----
